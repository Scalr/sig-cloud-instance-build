...
selinux --enforcing
timezone --utc UTC
repo --name="CentOS" --baseurl=http://mirror.centos.org/centos/5.11/os/i386/ --cost=100
repo --name="selinux" --baseurl=http://mirror.centos.org/centos/5.11/centosplus/i386/ --cost=100
